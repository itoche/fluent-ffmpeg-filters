...
class DatascopeFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Datascope.prototype.withSize = size;
    Datascope.prototype.withX = x;
    Datascope.prototype.withY = y;
    Datascope.prototype.withMode = mode;
    Datascope.prototype.withAxis = axis;
    Datascope.prototype.withOpacity = opacity;
  }
