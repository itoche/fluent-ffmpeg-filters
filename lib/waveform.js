...
class WaveformFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Waveform.prototype.withMode = mode;
    Waveform.prototype.withIntensity = intensity;
    Waveform.prototype.withMirror = mirror;
    Waveform.prototype.withDisplay = display;
    Waveform.prototype.withComponents = components;
    Waveform.prototype.withEnvelope = envelope;
    Waveform.prototype.withFilter = filter;
    Waveform.prototype.withGraticule = graticule;
    Waveform.prototype.withOpacity = opacity;
    Waveform.prototype.withFlags = flags;
    Waveform.prototype.withScale = scale;
    Waveform.prototype.withBgopacity = bgopacity;
  }
