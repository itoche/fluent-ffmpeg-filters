...
class AbufferFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Abuffer.prototype.withTime_base = time_base;
    Abuffer.prototype.withSample_rate = sample_rate;
    Abuffer.prototype.withSample_fmt = sample_fmt;
    Abuffer.prototype.withChannel_layout = channel_layout;
    Abuffer.prototype.withChannels = channels;
  }
