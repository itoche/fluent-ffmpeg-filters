...
class AbufferFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    AbufferFilter.prototype.withTime_base = time_base;
    AbufferFilter.prototype.withSample_rate = sample_rate;
    AbufferFilter.prototype.withSample_fmt = sample_fmt;
    AbufferFilter.prototype.withChannel_layout = channel_layout;
    AbufferFilter.prototype.withChannels = channels;
  }
