...
class YuvtestsrcFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    YuvtestsrcFilter.prototype.withColor = color;
    YuvtestsrcFilter.prototype.withLevel = level;
    YuvtestsrcFilter.prototype.withSize = size;
    YuvtestsrcFilter.prototype.withRate = rate;
    YuvtestsrcFilter.prototype.withSar = sar;
    YuvtestsrcFilter.prototype.withDuration = duration;
    YuvtestsrcFilter.prototype.withDecimals = decimals;
  }
