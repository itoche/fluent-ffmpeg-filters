...
class ElbgFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    ElbgFilter.prototype.withCodebook_length = codebook_length;
    ElbgFilter.prototype.withNb_steps = nb_steps;
    ElbgFilter.prototype.withSeed = seed;
    ElbgFilter.prototype.withPal8 = pal8;
  }
