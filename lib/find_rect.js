...
class Find_rectFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Find_rectFilter.prototype.withObject = object;
    Find_rectFilter.prototype.withThreshold = threshold;
    Find_rectFilter.prototype.withMipmaps = mipmaps;
    Find_rectFilter.prototype.withXmin = xmin;
  }
