...
class AphasemeterFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Aphasemeter.prototype.withRate = rate;
    Aphasemeter.prototype.withSize = size;
    Aphasemeter.prototype.withBc = bc;
    Aphasemeter.prototype.withMpc = mpc;
    Aphasemeter.prototype.withVideo = video;
  }
