...
class AphasemeterFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    AphasemeterFilter.prototype.withRate = rate;
    AphasemeterFilter.prototype.withSize = size;
    AphasemeterFilter.prototype.withBc = bc;
    AphasemeterFilter.prototype.withMpc = mpc;
    AphasemeterFilter.prototype.withVideo = video;
  }
