...
class DctdnoizFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    DctdnoizFilter.prototype.withSigma = this.sigma;
    DctdnoizFilter.prototype.withOverlap = this.overlap;
    DctdnoizFilter.prototype.withExpr = this.expr;
    DctdnoizFilter.prototype.withN = this.n;
  }
