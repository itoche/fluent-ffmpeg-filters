...
class DctdnoizFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    DctdnoizFilter.prototype.withSigma = sigma;
    DctdnoizFilter.prototype.withOverlap = overlap;
    DctdnoizFilter.prototype.withExpr = expr;
    DctdnoizFilter.prototype.withN = n;
  }
