...
class PaletteuseFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    PaletteuseFilter.prototype.withDither = dither;
    PaletteuseFilter.prototype.withBayer_scale = bayer_scale;
    PaletteuseFilter.prototype.withDiff_mode = diff_mode;
    PaletteuseFilter.prototype.withNew = _new;
  }
