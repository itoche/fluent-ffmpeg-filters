...
class TrebleFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    TrebleFilter.prototype.withGain = this.gain;
    TrebleFilter.prototype.withFrequency = this.frequency;
    TrebleFilter.prototype.withWidth_type = this.width_type;
    TrebleFilter.prototype.withWidth = this.width;
  }
