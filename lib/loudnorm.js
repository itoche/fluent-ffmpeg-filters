...
class LoudnormFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    LoudnormFilter.prototype.withI = I;
    LoudnormFilter.prototype.withLRA = LRA;
    LoudnormFilter.prototype.withTP = TP;
    LoudnormFilter.prototype.withMeasured_I = measured_I;
    LoudnormFilter.prototype.withMeasured_LRA = measured_LRA;
    LoudnormFilter.prototype.withMeasured_TP = measured_TP;
    LoudnormFilter.prototype.withMeasured_thresh = measured_thresh;
    LoudnormFilter.prototype.withOffset = offset;
    LoudnormFilter.prototype.withLinear = linear;
    LoudnormFilter.prototype.withDual_mono = dual_mono;
    LoudnormFilter.prototype.withPrint_format = print_format;
  }
