...
class PadFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    PadFilter.prototype.withHeight = height;
    PadFilter.prototype.withY = y;
    PadFilter.prototype.withColor = color;
    PadFilter.prototype.withEval = eval;
    PadFilter.prototype.withAspect = aspect;
  }
