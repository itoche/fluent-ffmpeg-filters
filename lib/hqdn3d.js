...
class Hqdn3dFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Hqdn3d.prototype.withLuma_spatial = luma_spatial;
    Hqdn3d.prototype.withChroma_spatial = chroma_spatial;
    Hqdn3d.prototype.withLuma_tmp = luma_tmp;
    Hqdn3d.prototype.withChroma_tmp = chroma_tmp;
  }
