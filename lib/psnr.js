...
class PsnrFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    PsnrFilter.prototype.withStats_file = this.stats_file;
    PsnrFilter.prototype.withStats_version = this.stats_version;
    PsnrFilter.prototype.withStats_add_max = this.stats_add_max;
  }
  ...
  build() {
    let opt = {};
    if (this._stats_file) {
      opt['stats_file'] = this._stats_file;
    }
    if (this._stats_version) {
      opt['stats_version'] = this._stats_version;
    }
    if (this._stats_add_max) {
      opt['stats_add_max'] = this._stats_add_max;
    }
