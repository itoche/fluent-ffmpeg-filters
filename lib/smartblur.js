...
class SmartblurFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    SmartblurFilter.prototype.withLuma_radius = luma_radius;
    SmartblurFilter.prototype.withLuma_strength = luma_strength;
    SmartblurFilter.prototype.withLuma_threshold = luma_threshold;
    SmartblurFilter.prototype.withChroma_radius = chroma_radius;
    SmartblurFilter.prototype.withChroma_strength = chroma_strength;
    SmartblurFilter.prototype.withChroma_threshold = chroma_threshold;
  }
