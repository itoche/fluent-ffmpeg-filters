...
class FlangerFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Flanger.prototype.withDelay = delay;
    Flanger.prototype.withDepth = depth;
    Flanger.prototype.withRegen = regen;
    Flanger.prototype.withWidth = width;
    Flanger.prototype.withSpeed = speed;
    Flanger.prototype.withShape = shape;
    Flanger.prototype.withPhase = phase;
    Flanger.prototype.withInterp = interp;
  }
