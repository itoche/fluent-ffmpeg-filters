...
class DrawgridFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    DrawgridFilter.prototype.withY = y;
    DrawgridFilter.prototype.withHeight = height;
    DrawgridFilter.prototype.withColor = color;
    DrawgridFilter.prototype.withThickness = thickness;
  }
