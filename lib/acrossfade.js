...
class AcrossfadeFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Acrossfade.prototype.withNb_samples = nb_samples;
    Acrossfade.prototype.withDuration = duration;
    Acrossfade.prototype.withOverlap = overlap;
    Acrossfade.prototype.withCurve1 = curve1;
    Acrossfade.prototype.withCurve2 = curve2;
  }
