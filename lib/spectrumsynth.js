...
class SpectrumsynthFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Spectrumsynth.prototype.withSample_rate = sample_rate;
    Spectrumsynth.prototype.withChannels = channels;
    Spectrumsynth.prototype.withScale = scale;
    Spectrumsynth.prototype.withSlide = slide;
    Spectrumsynth.prototype.withWin_func = win_func;
    Spectrumsynth.prototype.withOverlap = overlap;
    Spectrumsynth.prototype.withOrientation = orientation;
  }
