...
class DecimateFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Decimate.prototype.withCycle = cycle;
    Decimate.prototype.withDupthresh = dupthresh;
    Decimate.prototype.withScthresh = scthresh;
    Decimate.prototype.withBlocky = blocky;
    Decimate.prototype.withPpsrc = ppsrc;
    Decimate.prototype.withChroma = chroma;
  }
