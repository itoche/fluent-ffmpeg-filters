...
class AtrimFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    AtrimFilter.prototype.withStart = start;
    AtrimFilter.prototype.withEnd = end;
    AtrimFilter.prototype.withStart_pts = start_pts;
    AtrimFilter.prototype.withEnd_pts = end_pts;
    AtrimFilter.prototype.withDuration = duration;
    AtrimFilter.prototype.withStart_sample = start_sample;
    AtrimFilter.prototype.withEnd_sample = end_sample;
  }
