...
class RubberbandFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    RubberbandFilter.prototype.withTempo = tempo;
    RubberbandFilter.prototype.withPitch = pitch;
    RubberbandFilter.prototype.withTransients = transients;
    RubberbandFilter.prototype.withDetector = detector;
    RubberbandFilter.prototype.withPhase = phase;
    RubberbandFilter.prototype.withWindow = window;
    RubberbandFilter.prototype.withSmoothing = smoothing;
    RubberbandFilter.prototype.withFormant = formant;
    RubberbandFilter.prototype.withPitchq = pitchq;
    RubberbandFilter.prototype.withChannels = channels;
  }
