...
class RubberbandFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Rubberband.prototype.withTempo = tempo;
    Rubberband.prototype.withPitch = pitch;
    Rubberband.prototype.withTransients = transients;
    Rubberband.prototype.withDetector = detector;
    Rubberband.prototype.withPhase = phase;
    Rubberband.prototype.withWindow = window;
    Rubberband.prototype.withSmoothing = smoothing;
    Rubberband.prototype.withFormant = formant;
    Rubberband.prototype.withPitchq = pitchq;
    Rubberband.prototype.withChannels = channels;
  }
