...
class FramerateFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    FramerateFilter.prototype.withFps = fps;
    FramerateFilter.prototype.withInterp_start = interp_start;
    FramerateFilter.prototype.withInterp_end = interp_end;
    FramerateFilter.prototype.withScene = scene;
    FramerateFilter.prototype.withFlags = flags;
  }
