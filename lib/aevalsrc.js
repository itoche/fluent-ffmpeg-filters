...
class AevalsrcFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Aevalsrc.prototype.withExprs = exprs;
    Aevalsrc.prototype.withChannel_layout = channel_layout;
    Aevalsrc.prototype.withDuration = duration;
    Aevalsrc.prototype.withNb_samples = nb_samples;
    Aevalsrc.prototype.withSample_rate = sample_rate;
  }
