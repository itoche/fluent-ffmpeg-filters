...
class VectorscopeFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Vectorscope.prototype.withMode = mode;
    Vectorscope.prototype.withX = x;
    Vectorscope.prototype.withY = y;
    Vectorscope.prototype.withIntensity = intensity;
    Vectorscope.prototype.withEnvelope = envelope;
    Vectorscope.prototype.withGraticule = graticule;
    Vectorscope.prototype.withOpacity = opacity;
    Vectorscope.prototype.withFlags = flags;
    Vectorscope.prototype.withBgopacity = bgopacity;
    Vectorscope.prototype.withLthreshold = lthreshold;
    Vectorscope.prototype.withHthreshold = hthreshold;
    Vectorscope.prototype.withColorspace = colorspace;
  }
