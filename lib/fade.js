...
class FadeFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Fade.prototype.withType = type;
    Fade.prototype.withStart_frame = start_frame;
    Fade.prototype.withNb_frames = nb_frames;
    Fade.prototype.withAlpha = alpha;
    Fade.prototype.withStart_time = start_time;
    Fade.prototype.withDuration = duration;
    Fade.prototype.withColor = color;
  }
