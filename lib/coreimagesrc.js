...
class CoreimagesrcFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Coreimagesrc.prototype.withList_generators = list_generators;
    Coreimagesrc.prototype.withSize = size;
    Coreimagesrc.prototype.withRate = rate;
    Coreimagesrc.prototype.withSar = sar;
    Coreimagesrc.prototype.withDuration = duration;
  }
