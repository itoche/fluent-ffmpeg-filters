...
class CoreimagesrcFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    CoreimagesrcFilter.prototype.withList_generators = list_generators;
    CoreimagesrcFilter.prototype.withSize = size;
    CoreimagesrcFilter.prototype.withRate = rate;
    CoreimagesrcFilter.prototype.withSar = sar;
    CoreimagesrcFilter.prototype.withDuration = duration;
  }
  ...
  build() {
    let opt = {};
    if (this.list_generators) {
      opt['list_generators'] = this.list_generators;
    }
    if (this.size) {
      opt['size'] = this.size;
    }
