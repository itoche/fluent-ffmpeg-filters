...
class Readeia608Filter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Readeia608Filter.prototype.withLavfi_readeia608_X_cc = this.lavfi_readeia608_X_cc;
    Readeia608Filter.prototype.withLavfi_readeia608_X_line = this.lavfi_readeia608_X_line;
  }
  ...
  lavfi_readeia608_X_cc(val) {
    this._lavfi_readeia608_X_cc = val;
    return this;
  }
  ...
  lavfi_readeia608_X_line(val) {
    this._lavfi_readeia608_X_line = val;
    return this;
  }
  ...
  build() {
    let opt = {};
    if (this._lavfi_readeia608_X_cc) {
      opt['lavfi.readeia608.X.cc'] = this._lavfi_readeia608_X_cc;
    }
    if (this._lavfi_readeia608_X_line) {
      opt['lavfi.readeia608.X.line'] = this._lavfi_readeia608_X_line;
    }
