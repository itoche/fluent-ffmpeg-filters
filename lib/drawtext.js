...
class DrawtextFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Drawtext.prototype.withBox = box;
    Drawtext.prototype.withBoxborderw = boxborderw;
    Drawtext.prototype.withBoxcolor = boxcolor;
    Drawtext.prototype.withLine_spacing = line_spacing;
    Drawtext.prototype.withBorderw = borderw;
    Drawtext.prototype.withBordercolor = bordercolor;
    Drawtext.prototype.withExpansion = expansion;
    Drawtext.prototype.withBasetime = basetime;
    Drawtext.prototype.withFix_bounds = fix_bounds;
    Drawtext.prototype.withFontcolor = fontcolor;
    Drawtext.prototype.withFontcolor_expr = fontcolor_expr;
    Drawtext.prototype.withFont = font;
    Drawtext.prototype.withFontfile = fontfile;
    Drawtext.prototype.withAlpha = alpha;
    Drawtext.prototype.withFontsize = fontsize;
    Drawtext.prototype.withText_shaping = text_shaping;
    Drawtext.prototype.withFt_load_flags = ft_load_flags;
    Drawtext.prototype.withShadowcolor = shadowcolor;
    Drawtext.prototype.withShadowy = shadowy;
    Drawtext.prototype.withStart_number = start_number;
    Drawtext.prototype.withTabsize = tabsize;
    Drawtext.prototype.withTimecode = timecode;
    Drawtext.prototype.withTimecode_rate = timecode_rate;
    Drawtext.prototype.withTc24hmax = tc24hmax;
    Drawtext.prototype.withText = text;
    Drawtext.prototype.withTextfile = textfile;
    Drawtext.prototype.withReload = reload;
    Drawtext.prototype.withY = y;
  }
