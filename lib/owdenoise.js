...
class OwdenoiseFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    OwdenoiseFilter.prototype.withDepth = depth;
    OwdenoiseFilter.prototype.withLuma_strength = luma_strength;
    OwdenoiseFilter.prototype.withChroma_strength = chroma_strength;
  }
