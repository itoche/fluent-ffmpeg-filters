...
class SubtitlesFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Subtitles.prototype.withFilename = filename;
    Subtitles.prototype.withOriginal_size = original_size;
    Subtitles.prototype.withFontsdir = fontsdir;
    Subtitles.prototype.withCharenc = charenc;
    Subtitles.prototype.withStream_index = stream_index;
    Subtitles.prototype.withForce_style = force_style;
  }
