...
class LadspaFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    LadspaFilter.prototype.withFile = file;
    LadspaFilter.prototype.withPlugin = plugin;
    LadspaFilter.prototype.withControls = controls;
    LadspaFilter.prototype.withSample_rate = sample_rate;
    LadspaFilter.prototype.withNb_samples = nb_samples;
    LadspaFilter.prototype.withDuration = duration;
  }
