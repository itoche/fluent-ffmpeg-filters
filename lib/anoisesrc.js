...
class AnoisesrcFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    AnoisesrcFilter.prototype.withSample_rate = sample_rate;
    AnoisesrcFilter.prototype.withAmplitude = amplitude;
    AnoisesrcFilter.prototype.withDuration = duration;
    AnoisesrcFilter.prototype.withColor = color;
    AnoisesrcFilter.prototype.withSeed = seed;
    AnoisesrcFilter.prototype.withNb_samples = nb_samples;
  }
