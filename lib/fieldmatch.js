...
class FieldmatchFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    FieldmatchFilter.prototype.withOrder = order;
    FieldmatchFilter.prototype.withMode = mode;
    FieldmatchFilter.prototype.withPpsrc = ppsrc;
    FieldmatchFilter.prototype.withField = field;
    FieldmatchFilter.prototype.withMchroma = mchroma;
    FieldmatchFilter.prototype.withY1 = y1;
    FieldmatchFilter.prototype.withScthresh = scthresh;
    FieldmatchFilter.prototype.withCombmatch = combmatch;
    FieldmatchFilter.prototype.withCombdbg = combdbg;
    FieldmatchFilter.prototype.withCthresh = cthresh;
    FieldmatchFilter.prototype.withChroma = chroma;
    FieldmatchFilter.prototype.withBlocky = blocky;
    FieldmatchFilter.prototype.withCombpel = combpel;
  }
