...
class VaguedenoiserFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Vaguedenoiser.prototype.withThreshold = threshold;
    Vaguedenoiser.prototype.withMethod = method;
    Vaguedenoiser.prototype.withNsteps = nsteps;
    Vaguedenoiser.prototype.withPercent = percent;
    Vaguedenoiser.prototype.withPlanes = planes;
  }
