...
class VaguedenoiserFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    VaguedenoiserFilter.prototype.withThreshold = threshold;
    VaguedenoiserFilter.prototype.withMethod = method;
    VaguedenoiserFilter.prototype.withNsteps = nsteps;
    VaguedenoiserFilter.prototype.withPercent = percent;
    VaguedenoiserFilter.prototype.withPlanes = planes;
  }
