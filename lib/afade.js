...
class AfadeFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Afade.prototype.withType = type;
    Afade.prototype.withStart_sample = start_sample;
    Afade.prototype.withNb_samples = nb_samples;
    Afade.prototype.withStart_time = start_time;
    Afade.prototype.withDuration = duration;
    Afade.prototype.withCurve = curve;
  }
