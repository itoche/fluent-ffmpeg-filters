...
class CompandFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Compand.prototype.withDecays = decays;
    Compand.prototype.withPoints = points;
    Compand.prototype.withSoft_knee = soft_knee;
    Compand.prototype.withGain = gain;
    Compand.prototype.withVolume = volume;
    Compand.prototype.withDelay = delay;
  }
