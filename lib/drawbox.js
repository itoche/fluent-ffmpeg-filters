...
class DrawboxFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    DrawboxFilter.prototype.withY = y;
    DrawboxFilter.prototype.withHeight = height;
    DrawboxFilter.prototype.withColor = color;
    DrawboxFilter.prototype.withThickness = thickness;
  }
