...
class OcrFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    OcrFilter.prototype.withDatapath = datapath;
    OcrFilter.prototype.withLanguage = language;
    OcrFilter.prototype.withWhitelist = whitelist;
    OcrFilter.prototype.withBlacklist = blacklist;
  }
