...
class AnullsrcFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    AnullsrcFilter.prototype.withChannel_layout = channel_layout;
    AnullsrcFilter.prototype.withSample_rate = sample_rate;
    AnullsrcFilter.prototype.withNb_samples = nb_samples;
  }
