...
class CoreimageFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    CoreimageFilter.prototype.withList_filters = list_filters;
    CoreimageFilter.prototype.withFilter = filter;
    CoreimageFilter.prototype.withOutput_rect = output_rect;
  }
