...
class AechoFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    AechoFilter.prototype.withIn_gain = in_gain;
    AechoFilter.prototype.withOut_gain = out_gain;
    AechoFilter.prototype.withDelays = delays;
    AechoFilter.prototype.withDecays = decays;
  }
