...
class HdcdFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Hdcd.prototype.withDisable_autoconvert = disable_autoconvert;
    Hdcd.prototype.withProcess_stereo = process_stereo;
    Hdcd.prototype.withCdt_ms = cdt_ms;
    Hdcd.prototype.withForce_pe = force_pe;
    Hdcd.prototype.withAnalyze_mode = analyze_mode;
  }
