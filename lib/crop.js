...
class CropFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Crop.prototype.withW = w;
    Crop.prototype.withH = h;
    Crop.prototype.withX = x;
    Crop.prototype.withY = y;
    Crop.prototype.withKeep_aspect = keep_aspect;
    Crop.prototype.withExact = exact;
  }
