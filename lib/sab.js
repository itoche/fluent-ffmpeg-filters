...
class SabFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Sab.prototype.withLuma_radius = luma_radius;
    Sab.prototype.withLuma_pre_filter_radius = luma_pre_filter_radius;
    Sab.prototype.withLuma_strength = luma_strength;
    Sab.prototype.withChroma_radius = chroma_radius;
    Sab.prototype.withChroma_pre_filter_radius = chroma_pre_filter_radius;
    Sab.prototype.withChroma_strength = chroma_strength;
  }
