...
class SabFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    SabFilter.prototype.withLuma_radius = luma_radius;
    SabFilter.prototype.withLuma_pre_filter_radius = luma_pre_filter_radius;
    SabFilter.prototype.withLuma_strength = luma_strength;
    SabFilter.prototype.withChroma_radius = chroma_radius;
    SabFilter.prototype.withChroma_pre_filter_radius = chroma_pre_filter_radius;
    SabFilter.prototype.withChroma_strength = chroma_strength;
  }
