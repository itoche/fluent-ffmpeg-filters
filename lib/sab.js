...
class SabFilter {
  ...
  luma_pre_filter_radius(val) {
    this._luma_pre_filter_radius = val;
    return this;
  }
  ...
  chroma_pre_filter_radius(val) {
    this._chroma_pre_filter_radius = val;
    return this;
  }
  ...
  build() {
    ...
    if (this._luma_pre_filter_radius) {
      opt['luma_pre_filter_radius'] = this._luma_pre_filter_radius;
    }
    ...
    if (this._chroma_pre_filter_radius) {
      opt['chroma_pre_filter_radius'] = this._chroma_pre_filter_radius;
    }
