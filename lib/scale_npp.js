...
class Scale_nppFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Scale_nppFilter.prototype.withFormat = this.format;
    Scale_nppFilter.prototype.withInterp_algo = this.interp_algo;
  }
  ...
  build() {
    ...
    if (this._interp_algo) {
      opt['interp_algo'] = this._interp_algo;
    }
