...
class VignetteFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Vignette.prototype.withAngle = angle;
    Vignette.prototype.withY0 = y0;
    Vignette.prototype.withMode = mode;
    Vignette.prototype.withEval = eval;
    Vignette.prototype.withDither = dither;
    Vignette.prototype.withAspect = aspect;
  }
