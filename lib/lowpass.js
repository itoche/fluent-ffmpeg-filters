...
class LowpassFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Lowpass.prototype.withFrequency = frequency;
    Lowpass.prototype.withPoles = poles;
    Lowpass.prototype.withWidth_type = width_type;
    Lowpass.prototype.withWidth = width;
  }
