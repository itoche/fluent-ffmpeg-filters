...
class FliteFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    FliteFilter.prototype.withList_voices = list_voices;
    FliteFilter.prototype.withNb_samples = nb_samples;
    FliteFilter.prototype.withTextfile = textfile;
    FliteFilter.prototype.withText = text;
    FliteFilter.prototype.withVoice = voice;
  }
