...
class MandelbrotFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Mandelbrot.prototype.withEnd_pts = end_pts;
    Mandelbrot.prototype.withEnd_scale = end_scale;
    Mandelbrot.prototype.withInner = inner;
    Mandelbrot.prototype.withBailout = bailout;
    Mandelbrot.prototype.withMaxiter = maxiter;
    Mandelbrot.prototype.withOuter = outer;
    Mandelbrot.prototype.withRate = rate;
    Mandelbrot.prototype.withSize = size;
    Mandelbrot.prototype.withStart_scale = start_scale;
    Mandelbrot.prototype.withStart_x = start_x;
    Mandelbrot.prototype.withStart_y = start_y;
  }
