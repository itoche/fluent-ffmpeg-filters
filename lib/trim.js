...
class TrimFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    TrimFilter.prototype.withStart = start;
    TrimFilter.prototype.withEnd = end;
    TrimFilter.prototype.withStart_pts = start_pts;
    TrimFilter.prototype.withEnd_pts = end_pts;
    TrimFilter.prototype.withDuration = duration;
    TrimFilter.prototype.withStart_frame = start_frame;
    TrimFilter.prototype.withEnd_frame = end_frame;
  }
