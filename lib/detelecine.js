...
class DetelecineFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    DetelecineFilter.prototype.withFirst_field = this.first_field;
    DetelecineFilter.prototype.withPattern = this.pattern;
    DetelecineFilter.prototype.withStart_frame = this.start_frame;
  }
