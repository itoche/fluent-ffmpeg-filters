...
class Frei0r_srcFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Frei0r_srcFilter.prototype.withSize = size;
    Frei0r_srcFilter.prototype.withFramerate = framerate;
    Frei0r_srcFilter.prototype.withFilter_name = filter_name;
    Frei0r_srcFilter.prototype.withFilter_params = filter_params;
  }
