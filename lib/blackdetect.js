...
class BlackdetectFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    BlackdetectFilter.prototype.withBlack_min_duration = black_min_duration;
    BlackdetectFilter.prototype.withPicture_black_ratio_th = picture_black_ratio_th;
    BlackdetectFilter.prototype.withPixel_black_th = pixel_black_th;
  }
