...
class HisteqFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    HisteqFilter.prototype.withStrength = strength;
    HisteqFilter.prototype.withIntensity = intensity;
    HisteqFilter.prototype.withAntibanding = antibanding;
  }
  ...
  build() {
    ...
    if (this.antibanding) {
      opt['antibanding'] = this.antibanding;
    }
