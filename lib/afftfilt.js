...
class AfftfiltFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    AfftfiltFilter.prototype.withReal = real;
    AfftfiltFilter.prototype.withImag = imag;
    AfftfiltFilter.prototype.withWin_size = win_size;
    AfftfiltFilter.prototype.withWin_func = win_func;
    AfftfiltFilter.prototype.withOverlap = overlap;
  }
