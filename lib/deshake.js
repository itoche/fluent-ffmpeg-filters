...
class DeshakeFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Deshake.prototype.withH = h;
    Deshake.prototype.withRy = ry;
    Deshake.prototype.withEdge = edge;
    Deshake.prototype.withBlocksize = blocksize;
    Deshake.prototype.withContrast = contrast;
    Deshake.prototype.withSearch = search;
    Deshake.prototype.withFilename = filename;
    Deshake.prototype.withOpencl = opencl;
  }
