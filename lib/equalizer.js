...
class EqualizerFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Equalizer.prototype.withFrequency = frequency;
    Equalizer.prototype.withWidth_type = width_type;
    Equalizer.prototype.withWidth = width;
    Equalizer.prototype.withGain = gain;
  }
