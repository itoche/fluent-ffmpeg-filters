...
class SofalizerFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    SofalizerFilter.prototype.withSofa = sofa;
    SofalizerFilter.prototype.withGain = gain;
    SofalizerFilter.prototype.withRotation = rotation;
    SofalizerFilter.prototype.withElevation = elevation;
    SofalizerFilter.prototype.withRadius = radius;
    SofalizerFilter.prototype.withType = type;
    SofalizerFilter.prototype.withSpeakers = speakers;
  }
