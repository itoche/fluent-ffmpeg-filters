...
class SofalizerFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Sofalizer.prototype.withSofa = sofa;
    Sofalizer.prototype.withGain = gain;
    Sofalizer.prototype.withRotation = rotation;
    Sofalizer.prototype.withElevation = elevation;
    Sofalizer.prototype.withRadius = radius;
    Sofalizer.prototype.withType = type;
    Sofalizer.prototype.withSpeakers = speakers;
  }
