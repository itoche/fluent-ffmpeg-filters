...
class ReadvitcFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    ReadvitcFilter.prototype.withScan_max = scan_max;
    ReadvitcFilter.prototype.withThr_b = thr_b;
    ReadvitcFilter.prototype.withThr_w = thr_w;
  }
  ...
  build() {
    let opt = {};
    if (this.scan_max) {
      opt['scan_max'] = this.scan_max;
    }
    if (this.thr_b) {
      opt['thr_b'] = this.thr_b;
    }
    if (this.thr_w) {
      opt['thr_w'] = this.thr_w;
    }
