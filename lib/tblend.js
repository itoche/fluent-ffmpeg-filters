...
class TblendFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    TblendFilter.prototype.withAll_mode = all_mode;
    TblendFilter.prototype.withAll_opacity = all_opacity;
    TblendFilter.prototype.withAll_expr = all_expr;
    TblendFilter.prototype.withShortest = shortest;
    TblendFilter.prototype.withRepeatlast = repeatlast;
  }
