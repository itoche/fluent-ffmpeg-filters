...
class OverlayFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Overlay.prototype.withY = y;
    Overlay.prototype.withEof_action = eof_action;
    Overlay.prototype.withEval = eval;
    Overlay.prototype.withShortest = shortest;
    Overlay.prototype.withFormat = format;
    Overlay.prototype.withRgb (deprecated) = rgb (deprecated);
    Overlay.prototype.withRepeatlast = repeatlast;
  }
  ...
  build() {
    ...
    if (this.rgb (deprecated)) {
      opt.rgb (deprecated) = this.rgb (deprecated);
    }
    if (this.repeatlast) {
