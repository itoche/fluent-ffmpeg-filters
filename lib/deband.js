...
class DebandFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Deband.prototype.with_4thr = _4thr;
    Deband.prototype.withRange = range;
    Deband.prototype.withDirection = direction;
    Deband.prototype.withBlur = blur;
    Deband.prototype.withCoupling = coupling;
  }
