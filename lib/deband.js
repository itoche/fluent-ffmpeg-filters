...
class DebandFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    DebandFilter.prototype.with_4thr = _4thr;
    DebandFilter.prototype.withRange = range;
    DebandFilter.prototype.withDirection = direction;
    DebandFilter.prototype.withBlur = blur;
    DebandFilter.prototype.withCoupling = coupling;
  }
