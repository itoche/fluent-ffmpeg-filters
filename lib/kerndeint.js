...
class KerndeintFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    KerndeintFilter.prototype.withThresh = thresh;
    KerndeintFilter.prototype.withMap = map;
    KerndeintFilter.prototype.withOrder = order;
    KerndeintFilter.prototype.withSharp = sharp;
    KerndeintFilter.prototype.withTwoway = twoway;
  }
