...
class TileFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Tile.prototype.withLayout = layout;
    Tile.prototype.withNb_frames = nb_frames;
    Tile.prototype.withMargin = margin;
    Tile.prototype.withPadding = padding;
    Tile.prototype.withColor = color;
  }
