...
class StereowidenFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    StereowidenFilter.prototype.withDelay = delay;
    StereowidenFilter.prototype.withFeedback = feedback;
    StereowidenFilter.prototype.withCrossfeed = crossfeed;
    StereowidenFilter.prototype.withDrymix = drymix;
  }
