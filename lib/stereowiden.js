...
class StereowidenFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Stereowiden.prototype.withDelay = delay;
    Stereowiden.prototype.withFeedback = feedback;
    Stereowiden.prototype.withCrossfeed = crossfeed;
    Stereowiden.prototype.withDrymix = drymix;
  }
