...
class ScaleFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Scale.prototype.withHeight = height;
    Scale.prototype.withEval = eval;
    Scale.prototype.withInterl = interl;
    Scale.prototype.withFlags = flags;
    Scale.prototype.withParam0 = param0;
    Scale.prototype.withSize = size;
    Scale.prototype.withOut_color_matrix = out_color_matrix;
    Scale.prototype.withOut_range = out_range;
    Scale.prototype.withForce_original_aspect_ratio = force_original_aspect_ratio;
  }
