...
class PerspectiveFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Perspective.prototype.withY3 = y3;
    Perspective.prototype.withInterpolation = interpolation;
    Perspective.prototype.withSense = sense;
    Perspective.prototype.withEval = eval;
  }
