...
class DynaudnormFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    DynaudnormFilter.prototype.withF = this.f;
    DynaudnormFilter.prototype.withG = this.g;
    DynaudnormFilter.prototype.withP = this.p;
    DynaudnormFilter.prototype.withM = this.m;
    DynaudnormFilter.prototype.withR = this.r;
    DynaudnormFilter.prototype.withN = this.n;
    DynaudnormFilter.prototype.withC = this.c;
    DynaudnormFilter.prototype.withB = this.b;
    DynaudnormFilter.prototype.withS = this.s;
  }
