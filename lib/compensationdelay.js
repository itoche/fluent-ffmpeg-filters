...
class CompensationdelayFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Compensationdelay.prototype.withMm = mm;
    Compensationdelay.prototype.withCm = cm;
    Compensationdelay.prototype.withM = m;
    Compensationdelay.prototype.withDry = dry;
    Compensationdelay.prototype.withWet = wet;
    Compensationdelay.prototype.withTemp = temp;
  }
