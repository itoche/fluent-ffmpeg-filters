...
class CompensationdelayFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    CompensationdelayFilter.prototype.withMm = mm;
    CompensationdelayFilter.prototype.withCm = cm;
    CompensationdelayFilter.prototype.withM = m;
    CompensationdelayFilter.prototype.withDry = dry;
    CompensationdelayFilter.prototype.withWet = wet;
    CompensationdelayFilter.prototype.withTemp = temp;
  }
