...
class AphaserFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    AphaserFilter.prototype.withIn_gain = in_gain;
    AphaserFilter.prototype.withOut_gain = out_gain;
    AphaserFilter.prototype.withDelay = delay;
    AphaserFilter.prototype.withDecay = decay;
    AphaserFilter.prototype.withSpeed = speed;
    AphaserFilter.prototype.withType = type;
  }
