...
class GblurFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    GblurFilter.prototype.withSigma = sigma;
    GblurFilter.prototype.withSteps = steps;
    GblurFilter.prototype.withPlanes = planes;
    GblurFilter.prototype.withSigmaV = sigmaV;
  }
