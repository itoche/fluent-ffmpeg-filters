...
class PalettegenFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    PalettegenFilter.prototype.withMax_colors = max_colors;
    PalettegenFilter.prototype.withReserve_transparent = reserve_transparent;
    PalettegenFilter.prototype.withStats_mode = stats_mode;
  }
