...
class PalettegenFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    Palettegen.prototype.withMax_colors = max_colors;
    Palettegen.prototype.withReserve_transparent = reserve_transparent;
    Palettegen.prototype.withStats_mode = stats_mode;
  }
