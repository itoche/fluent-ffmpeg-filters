...
class ChorusFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    ChorusFilter.prototype.withIn_gain = in_gain;
    ChorusFilter.prototype.withOut_gain = out_gain;
    ChorusFilter.prototype.withDelays = delays;
    ChorusFilter.prototype.withDecays = decays;
    ChorusFilter.prototype.withSpeeds = speeds;
    ChorusFilter.prototype.withDepths = depths;
  }
