...
class AemphasisFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    AemphasisFilter.prototype.withLevel_in = level_in;
    AemphasisFilter.prototype.withLevel_out = level_out;
    AemphasisFilter.prototype.withMode = mode;
    AemphasisFilter.prototype.withType = type;
  }
