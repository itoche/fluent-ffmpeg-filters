...
class MovieFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    MovieFilter.prototype.withFilename = filename;
    MovieFilter.prototype.withFormat_name = format_name;
    MovieFilter.prototype.withSeek_point = seek_point;
    MovieFilter.prototype.withStreams = streams;
    MovieFilter.prototype.withStream_index = stream_index;
    MovieFilter.prototype.withLoop = loop;
    MovieFilter.prototype.withDiscontinuity = discontinuity;
  }
