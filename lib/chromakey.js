...
class ChromakeyFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    ChromakeyFilter.prototype.withColor = color;
    ChromakeyFilter.prototype.withSimilarity = similarity;
    ChromakeyFilter.prototype.withBlend = blend;
    ChromakeyFilter.prototype.withYuv = yuv;
  }
