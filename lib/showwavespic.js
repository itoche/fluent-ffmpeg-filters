...
class ShowwavespicFilter {
  ...
  constructor (ffmpeg) {
    this.ffmpeg = ffmpeg;
    ShowwavespicFilter.prototype.withSize = size;
    ShowwavespicFilter.prototype.withSplit_channels = split_channels;
    ShowwavespicFilter.prototype.withColors = colors;
    ShowwavespicFilter.prototype.withScale = scale;
  }
